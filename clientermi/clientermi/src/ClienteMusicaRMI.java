...
public class ClienteMusicaRMI {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            /*
             * La parte importante del código, que permite al cliente obtener el stub para comunicarse con el objeto remoto, es la siguiente:
             */
			registry = LocateRegistry.getRegistry("192.168.1.144", 5056);
